...
describe('GET /my-scale/resize', function() {
  it('should respond with 404', () => {
    return request(app).get('/my-scale/resize').expect(404)
  })

  it('should respond with 400', () => {
    return request(app).get('/my-scale/resize/100').expect(400)
  })

  it('should respond with 400', () => {
    return request(app).get('/my-scale/resize/100a?url=/whatever').expect(400)
  })
